...
long_intro = """
  안녕하세요 ! 저는 다양한 분들의 심리적 안정을 도와 드리고 있습니다. 특히 학교나 직장 내의 인간 관계로 인한 스트레스를 겪으시거나 번아웃 증상이 있으신 분들을 주로 상담하고 있습니다.

  저는 내담자분들의 이야기에 귀 기울이며, 그들의 감정과 생각을 존중하는 것을 최우선으로 합니다. 각 개인의 독특한 경험과 배경을 고려하여 맞춤형 상담을 제공하고자 노력하고 있습니다."""
long_counsel_info = """⦁  당신의 고민거리을 직접 전해주세요.|||⦁  직접 찾아가기 어렵거나 부담된다면 온라인으로 진행할 수 있어요.|||⦁  월요일 ~ 금요일 : 10:00 ~ 18:00
"""
sample_history = """
✔ 경상국립대학교 심리학과 석사
✔ 스트레스 관리 및 번아웃 치료 전문 
...
async def create_review(
    ...
    willingness_to_recounsel: int = Form(...),
    personalized_feedback: int = Form(...),
    kindness: int = Form(...),
    total_ratio: int = Form(...),
    db: Session = Depends(get_db),
):
    db_review = Review(
        ...
        willingness_to_recounsel=willingness_to_recounsel,
